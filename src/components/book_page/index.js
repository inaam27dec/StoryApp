...
class FlipPage extends React.Component {
  ...
  goToPage(page) {
    ...
    if (page >= 0 && page < children.length) {
      this.setState({page}, () => {
        ...
        this.props.onPageChange(page, 'set');
      });
    } else {
  ...
  isLastPage() {
    return this.state.page + 1 === this.flatChildren().length;
  }
...
FlipPage.propTypes = {
  ...
  onPageStartMoving: PropTypes.func,
